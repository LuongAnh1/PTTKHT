...
-- ============================================
-- 5. DỮ LIỆU BANG_GIA (MỚI - TỪ FILE 2)
-- ============================================
...
-- ============================================
-- 6. DỮ LIỆU CHUONG_TRINH_KM (MỚI - TỪ FILE 2)
-- ============================================
INSERT INTO CHUONG_TRINH_KM (TenCT, MaCode, NgayBatDau, NgayKetThuc, TrangThai) VALUES
('Sale Hè', 'SALE23', '2023-08-01', '2023-08-31', 1),
('Black Friday', 'BF23', '2023-11-24', '2023-11-26', 2);

-- ============================================
-- 7. DỮ LIỆU HOA_DON (Bao gồm cả Phiếu Nhập và Phiếu Xuất)
-- ============================================
...
-- ============================================
-- 9. DỮ LIỆU PHIEU_NHAP_KHO
-- ============================================
INSERT INTO PHIEU_NHAP_KHO (MaPNK, NgayNhap, MaNCC, MaNV, TongTien, ChietKhau, TrangThai, GhiChu) VALUES
('PNK001', '2023-10-01 08:00:00', 1, 4, 17500000, 0, 1, 'Nhập hàng đầu tháng từ ABC'), 
('PNK002', '2023-10-05 09:30:00', 2, 4, 7500000, 500000, 1, 'Nhập bổ sung quần Jean'), 
('PNK003', '2023-10-10 10:00:00', 3, 4, 13500000, 0, 0, 'Nhập hàng bổ sung'), 
('PNK004', '2023-10-15 14:00:00', 1, 4, 5000000, 0, 0, 'Nhập áo thun mùa hè'); 

-- ============================================
-- 10. DỮ LIỆU CHI_TIET_PHIEU_NHAP_KHO
-- ============================================
...
-- ============================================
-- 11. DỮ LIỆU PHIEU_XUAT_KHO
-- ============================================
INSERT INTO PHIEU_XUAT_KHO (MaPXK, NgayXuat, MaNV, NguoiNhan, ChietKhau, TrangThai, GhiChu) VALUES
('PXK001', '2023-10-06 10:00:00', 2, 'Khách lẻ (Walk-in)', 0, 1, 'Xuất cho hóa đơn HD001'), 
('PXK002', '2023-10-06 11:15:00', 2, 'Đại lý Minh Châu', 500000, 1, 'Xuất cho hóa đơn HD002'), 
('PXK003', '2023-10-07 14:20:00', 3, 'Chi nhánh Cầu Giấy', 0, 0, 'Xuất cho hóa đơn HD003'), 
('PXK004', '2023-10-12 09:00:00', 4, 'Siêu thị VinMart', 0, 0, 'Xuất hàng cho khách'), 
('PXK005', '2023-10-18 15:00:00', 4, 'Khách lẻ (Walk-in)', 0, 1, 'Hàng bị lỗi, xuất hủy'); 

-- ============================================
-- 12. DỮ LIỆU CHI_TIET_PHIEU_XUAT_KHO
-- ============================================
...
-- ============================================
-- 14. DỮ LIỆU CHI_TIET_PHIEU_KIEM_KE
-- ============================================
